...
def train(args):
    class WKPooling(nn.Module):
        def __init__(self, layer_start, context_window_size):
    ...
    class CustomModel(nn.Module):
        def __init__(self, tokenizer):
            ...
            self.pool = WKPooling(layer_start=args.layer_start, context_window_size=args.context_window_size)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--layer_start", default=12, type=int)
    parser.add_argument("--context_window_size", default=1024, type=int)

...
if CFG.USE_EssayProcessor:
    ...
    train_essay_agg_df = train.merge(
        train_sent_agg_df,
        on="essay_id",
        how="left"
    )
...
if CFG.USE_ORIGINAL_TFIDF_VECTORIZER:
    ...
    df_test = use_tf_idf_vectorizer_for_test(
...
if CFG.USE_ORIGINAL_COUNT_VECTORIZER:
    ...
    df_test = use_count_vectorizer_for_test(
...
lgbm_models, lgbm_model_nums, lgbm_predictions = train_lgbm(
    X_train=train,
    X_test=test
)
